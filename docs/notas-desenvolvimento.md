...
| v0.61.3      | `refresh.yml` reduzido de 2×/dia para 1×/dia (`10 3,17 * * *` → `10 3 * * *`) para aliviar a cota de egress do Supabase enquanto a migração para o VPS (`docs/economia-fase-2-vps-unico.md`) está em andamento; corrige de passagem `README.md` que ainda dizia "4×/dia" |
