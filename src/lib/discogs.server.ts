...
// PUBLIC_BASE_URL é o domínio real no VPS; sem ela (dev local), cai num placeholder
// só como identificação — não afeta nenhuma chamada.
const UA = `GarimpoDeVinil/1.0 (+${process.env["PUBLIC_BASE_URL"] || "https://garimpo.local"})`;
const CURRENCY = "BRL";
